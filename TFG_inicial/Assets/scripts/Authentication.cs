...
public class Authentication : MonoBehaviour {
    ...
    private const string Login_url = "http://monitorizer.sytes.net:8000/api-token-auth/"; //"http://localhost:8000/api-token-auth/";
    private const string Register_url = "http://monitorizer.sytes.net:8000/polls/users/register/"; //"http://localhost:8000/polls/users/register/";
    private const string Check_AppCode_url = "http://monitorizer.sytes.net:8000/polls/class/checkAppCode";
